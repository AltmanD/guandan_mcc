...
class ExampleClient(WebSocketClient):
    ...
    def received_message(self, message):
        ...
        # print("我的主机号",message['myPos'])
        # if (message['type'] == 'notify'):
        #     myclient = self.state.notify_play()
...
if __name__ == '__main__':
    try:
        # ws = ExampleClient('ws://39.108.189.48:80/game/gd/18762111338605314')
        ws = ExampleClient('ws://112.124.24.226:80/game/gd/17550225823559342')
