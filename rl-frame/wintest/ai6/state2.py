...
class State(object):
    ...
    def parse(self, msg):
        ...
        for key, value in msg.items():
            # print(key,value)
            setattr(self, "_{}".format(key), value)  #setattr()函数
        try:
    ...
    def notify_tribute(self):
        ...
        """
        # TODO: 选手可自行做出其他处理
        print("这是进贡时的手牌",self._handCards)
    ...
    def act_play(self):
        ...
        # print("这是手牌",self._handCards)
        # print("这是greatAction",self._greaterAction)
