...
# parser.add_argument('--pool_size', type=int, default=512, help='The max length of data pool')
...
def main():
    ...
    with open('./fullplay72000.ckpt', 'rb') as f:
        ...
        if len(mem_pool) >= args.batch_size:
            ...
            if model_save_freq%args.ckpt_save_freq == 0:
                if args.ckpt_save_type == 'checkpoint':
                    ...
                    with open(args.ckpt_path / f'fullplay{model_save_freq}.ckpt', 'wb') as f:
